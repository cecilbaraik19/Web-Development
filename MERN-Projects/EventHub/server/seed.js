...
const users = [
    ...
    { name: 'Demo User', email: 'user@eventhub.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@eventhub.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@eventhub.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@eventhub.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@eventhub.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@eventhub.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@eventhub.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@eventhub.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@eventhub.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@eventhub.com');
        console.log('User Email:  user@eventhub.com');
