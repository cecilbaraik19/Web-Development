...
const FOCUS_AREAS = [
  { Icon: FaCode, title: 'Full Stack Development', text: 'Building end-to-end apps with the MERN stack.' },
  { Icon: FaShieldAlt, title: 'Cybersecurity', text: 'Bug bounty hunting and web app penetration testing.' },
  { Icon: FaCloud, title: 'Cloud', text: 'Learning AWS — compute, storage and identity.' },
  { Icon: FaNetworkWired, title: 'Networking', text: 'Protocols, subnets and how packets really move.' },
];
...
export default function About() {
  ...
  return (
    <section id="about" data-testid="about-section" className="mx-auto max-w-6xl px-6 py-28">
      <SectionHeading
        number="01"
        eyebrow="About"
        ...
        <Reveal>
          <div className="relative mx-auto aspect-[4/5] w-full max-w-sm overflow-hidden rounded-2xl border border-white/10 bg-secondary">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="font-display text-7xl font-bold text-accent/30">CB</span>
            </div>
            {/* Corner brackets */}
        ...
        <div>
          <Reveal delay={0.1}>
            <p className="text-base leading-relaxed text-muted md:text-lg">
              I'm Cecil — I started with curiosity about how websites work, and that curiosity
              turned into a habit of building. My learning journey took me from HTML and CSS to
              shipping full stack apps with MongoDB, Express, React and Node.
            </p>
            <p className="mt-4 text-base leading-relaxed text-muted md:text-lg">
              Right now my focus is split between sharpening my MERN skills and going deeper into
              AWS, while studying for networking and security fundamentals. I hunt bugs on the side
              to understand how attackers think.
            </p>
            <p className="mt-4 text-base leading-relaxed text-muted md:text-lg">
              The goal ahead: become a <span className="text-accent">DevSecOps engineer</span> —
              someone who builds software and knows how to defend it.
            </p>
          </Reveal>

          <Reveal delay={0.2}>
            <div ref={statsRef} className="mt-10 grid grid-cols-3 gap-6">
              <Stat end={10} suffix="+" label="Projects Built" started={statsVisible} />
              <Stat end={12} suffix="+" label="Technologies Explored" started={statsVisible} />
              <Stat end={2} suffix="" label="Certifications Earned" started={statsVisible} />
            </div>
          </Reveal>
        </div>
      </div>
