          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="bg-slate-900/90 backdrop-blur-sm p-5 rounded-xl border border-slate-800 hover:border-cyan-800 hover:shadow-glow-cyan transition-all duration-300 flex flex-col gap-4">
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-cyan-600 hover:bg-cyan-500 hover:shadow-glow-cyan py-2.5 rounded-lg font-medium text-sm transition-all flex items-center justify-center gap-2 disabled:opacity-80"
              >
                {loading ? (
