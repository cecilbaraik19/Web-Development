  ...
  return (
    <footer className="w-full bg-white text-gray-700 font-sans border-t border-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <div className="flex flex-col space-y-3">
          <div className="flex items-center space-x-2 text-orange-500 font-black text-3xl tracking-wide">
            <span className="bg-orange-500 text-white rounded-2xl px-3 py-1 text-xl font-extrabold mr-1">
              S
            </span>
      ...
      <div className="max-w-[1200px] mx-auto px-4 text-center">
        ...
        <p className="text-sm text-black-400 mt-3 max-w-3xl mx-auto">
          This is a <span className="font-medium">Swiggy-inspired clone</span>{" "}
          created for educational and portfolio purposes. It is not affiliated
          with
